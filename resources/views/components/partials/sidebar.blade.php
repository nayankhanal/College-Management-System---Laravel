    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <!-- <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('departments.create')}}"><i class="fa fa-circle-o"></i> General Elements</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('departments.index')}}"><i class="fa fa-circle-o"></i> Simple tables</a></li>
