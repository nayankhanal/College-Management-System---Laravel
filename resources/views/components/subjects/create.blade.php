...
<div class="container">
    <form action="{{route('subjects.store')}}" method="post"><br><br>
        @csrf
    <div class="form-group">
        <label for="name">Subject</label>
        <input type="text" name="name" value="{{old('name')}}" class="form-control" id="name" aria-describedby="name" placeholder="Enter subject">
        @if($errors->has('name'))
