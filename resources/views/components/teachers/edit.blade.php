...
<div class="container">
    <form action="{{route('teachers.update', [$teacher->id])}}" method="post"><br><br>
        @method('put')
        @csrf
    <div class="form-group">
        <label for="user_id">Teacher</label>
            <select name="user_id" id="user_id" class="form-control" style="pointer-events: none;">
                ...
                <option value="{{$teach->user_id}}" {{$teach->user_id == $teacher->user_id ? 'selected' : ''}}>{{$teacher->user->name}}</option>
                @endforeach
            </select>
    ...
    <div class="form-group">
        ...
        <span class="help-block text-danger" style="color: red;">{{$errors->first('department_id')}}</span>
        @endif
    </div>
