...
<div class="container">
    ...
    <div class="form-group">
        ...
        <input type="text" name="name" value="{{old('name', $user->name)}}" class="form-control" id="name" aria-describedby="name" placeholder="Enter name">
        @if($errors->has('name'))
    ...
    <div class="form-group">
        ...
        <input type="email" name="email" value="{{old('email', $user->email)}}" class="form-control" id="email" aria-describedby="email" placeholder="Enter email">
        @if($errors->has('email'))
